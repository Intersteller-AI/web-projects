...
const Profile = () => {
  ...
  return (
    <>
      <div className="profile-section md:max-w-[400px] w-full flex md:flex-col flex-row max-h-[120vh] rounded-lg overflow-y-scroll hide-scrollbar mt-4 drop-shadow-md bg-[#fffefe]">
        {/* profile info */}
      ...
      {/* mobile view */}
      <div
        className={`${openProfile.isOpen ? 'sec-up' : 'sec-down'} w-[95vw] sm:hidden flex flex-col max-h-[120vh] rounded-lg drop-shadow-md bg-[#fffefe] absolute top-20 -translate-x-[50%] left-[50%] overflow-hidden`}
      >
        {/* profile section */}
