  ...
  <div className="w-full mt-4">
    ...
    <div className="w-full px-3">
      {dataArray?.map((val, index) => (
        ...
        >
          <val.icon className="sm:text-[22px]"></val.icon>
...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="w-[250px] sm:px-2 h-[100vh] sm:block hidden fixed left-0 top-0 text-white overflow-y-auto hide-scrollbar">
