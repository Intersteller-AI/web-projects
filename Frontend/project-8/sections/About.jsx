    ...
    <div className="sm:p-16 xs:p-8 px-6 py-12">
      ...
      >
        ...
        <motion.p
          ...
          className="mt-[8px] font-normal sm:text-[26px] max-w-7xl text-[18px] text-center text-secondary-white"
        >
          ...
          metaverseworld you want, turn your dreams into reality. Let's explore
